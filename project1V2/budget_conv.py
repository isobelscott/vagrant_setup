...
if __name__ == "__main__":
    ...
    print("You spent " + str(round(get_amount, 3)) + " " +  str(get_currency) + ". Which is $" + str(get_amount_usd)  + " USD.")
    print("Your remaining budget is $" + str(new_budget) + " USD. Which is " + str(new_budget_fc) + " " + str(get_currency) + ".")
