...
if __name__ == '__main__':
    ...
    print(str(readable_transit['years']) + " year, " + str(readable_transit['days']) +  " days, " + str(readable_transit['hours']) + " hours, " + str(readable_transit['minutes']) + " minutes, and " + str(readable_transit['seconds']) + " seconds.")
